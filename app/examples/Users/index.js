...
export class Users extends Component {
  ...
  loadUserDetails = ({
    ...
    /**
		  // Actual API Call
			...
			let requestURL = `${API_URL}${USERS}?pagination=1&pageSize=${
				pagination.pageSize
   ...
   */
  updateUser = () => {
    const { userStoreData, reset } = this.props;
      ...
      >
        <form onSubmit={this.updateUser} className="mb-3">
          <Field
            ...
            component={AInput}
            label="Email *"
            placeholder="john.doe@dressy.club"
    ...
    return (
      <div>
        <Helmet>
          ...
          <meta name="description" content="Users for DressyClub" />
        </Helmet>
        <PageHeaderWrapper
          title="Users"
          extra={[
